...
namespace Han\TabBundle\Controller;

use Han\TabBundle\Entity\Product;
...
class ProductController extends Controller
{
    ...
    {
        $product = new Product();
        $form = $this->createForm('Han\TabBundle\Form\ProductType', $product);
    ...
    {
        $deleteForm = $this->createDeleteForm($product);
        $editForm = $this->createForm('Han\TabBundle\Form\ProductType', $product);
